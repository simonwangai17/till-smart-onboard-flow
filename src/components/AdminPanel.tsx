...
import { CheckCircle, XCircle, MessageSquare, User, Calendar, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-mpesa-gray">Review and approve pending customer registrations</p>
      </div>
